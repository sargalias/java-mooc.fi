...
public class FirstPackagesTest {
    ...
    public void hasUserInterface() {
        Class clazz = null;
        try {
            clazz = ReflectionUtils.findClass("UserInterface");
        } catch (Throwable e) {
    ...
    public void hasTextUserInterface() {
        Class clazz = ReflectionUtils.findClass("TextUserInterface");

        if (clazz == null) {
            fail("Have you created public class TextUserInterface inside the package mooc.ui?");
        }

        Class ui = ReflectionUtils.findClass("UserInterface");
    ...
    public void hasApplicationLogic() {
        ...
        Class uiClass = ReflectionUtils.findClass("UserInterface");
